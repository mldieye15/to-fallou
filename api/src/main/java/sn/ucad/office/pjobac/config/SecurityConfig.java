    ...
    public SecurityFilterChain filterChain( HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .requestMatchers("/web/**",
                        ...
                        "/pjobac/api/v1/academies/libelle-availability",
                        "/pjobac/api/v1/sessions/candidaturesOuvertes",
                        "/pjobac/api/v1/sessions/enCoursSession",
                        "/pjobac/api/v1/sessions/sessionsOuvertes",
                        "/pjobac/api/v1/sessions/{id}",
                        "/pjobac/api/v1/villes/all",
                        "/pjobac/api/v1/villes/by-academie/{idAcademie}",
                        "/pjobac/api/v1/academies/all",
                        "/pjobac/api/v1/demandes/addAll",
