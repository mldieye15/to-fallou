...
public interface CodificationMapper {
    // transform the entity to PJO class
    CodificationResponse toEntiteResponse(Codification Codification);
    ...
    CodificationAudit toEntiteAudit(Codification Codification, Long auteurName, Long modifName);

    // request to entity typeEtablissement
    Codification requestToEntity(CodificationRequest request);

    // transform the PJO request to an entity
    //@Mapping(source = "user", target = "utiCree")
    Codification requestToEntiteAdd(CodificationRequest CodificationRequest/*, Utilisateur user*/);   // ici on n'a pa la classe Utilisateur

    // request to existing entity
    //@Mapping(source = "user", target = "utiModifie")
    Codification requestToEntiteUp(@MappingTarget Codification entity, CodificationRequest request/*, Utilisateur user*/);
