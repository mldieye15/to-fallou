...
@RestController
@RequestMapping("/pjobac/v1/fonctions")
...
public class FonctionResource {
    ...
    public ResponseEntity<Boolean> checklibelleAvailabilityUp(@RequestParam Long fonctionId, @RequestParam String libelleLong) {
        try {
            boolean isUnique = service.verifyLibelleLongUniqueUp(libelleLong, fonctionId);
