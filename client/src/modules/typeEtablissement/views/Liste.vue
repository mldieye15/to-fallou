<template>
  <div>
    <p class="text-h6">{{ $t('apps.forms.typeEtablissement.typeEtablissement') }}</p>
      ...
      <v-row class="mb-0 mx-auto pa-1"  align="center">
        ...
        <v-col cols="auto">
          <!-- <v-btn variant="outlined" color="black" >
            <router-link :to="{ name: 'typeEtablissement-add' }" class="">
          ...
          <div class="actions-wrapper">
            ...
            <v-dialog   transition="dialog-top-transition" width="50%" height="auto">
              ...
              <template v-slot:default="{ isActive }">
                <v-card>
                  <v-toolbar color="primary" :title="$t('apps.forms.typeEtablissement.typeEtablissement')"></v-toolbar>
                  <v-card-text>
...
const redirectToAdd= () => {
  router.push({ name: 'typeEtablissement-add'});
};
