<template>
  <div>
    <p class="text-h6">{{ $t('apps.forms.user.planif') }}</p>
    ...
    <v-container class="my-5">
      ...
      <vue-good-table
        ...
        <template #table-row="props">
          <div v-if="props.column.field === 'actions'">
            <div class="actions-wrapper">
            <router-link :to="{ name: 'planif-details', params: { id: props.row.id } }"> <v-icon small flat color="green dark">mdi-eye</v-icon> </router-link>
            <router-link :to="{ name: 'planif-edit', params: { id: props.row.id } }" class="ml-4"> <v-icon small flat color="blue dark">mdi-pencil</v-icon> </router-link>
